...
export const dashboardCopy = {
  en: {
    ...
    unavailableState: "AI Coach is currently unavailable.",
    readOnlyNotice: "AI Coach is currently operating in read-only mode.",
  ...
  ar: {
    ...
    modules: "وحدات Rahafit الخاصة بك",
    ...
    unavailableState: "المدرب الذكي غير متاح حاليًا.",
    readOnlyNotice: "مساعد المدرب الذكي يعمل في وضع القراءة والمراجعة حالياً.",
    readOnlyStatus: "قراءة فقط",
